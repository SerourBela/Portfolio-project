...
<head>
    ...
    <title> معالجة <?php echo $__env->yieldContent('title'); ?></title>
...
<div class="wrapper">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <span class="badge badge-danger navbar-badge"> <?php echo e(\App\Notificationtrait::select('notificationtraits.detail')->join('traitants', 'traitants.id_traitant', '=', 'notificationtraits.traitant_id')->
    where('traitants.user_id',Auth::user()->id)-> where('notificationtraits.etat',1) ->count()); ?></span>
                        ...
                        <a >
                            ...
                            <?php else: ?>
                                <li style="padding:10px">
                                    <?php endif; ?>
                                    <div class="row">
                                        <a href="<?php echo e(url('/notifications')); ?>/<?php echo e($note->id); ?>" class="dropdown-item">

                                            <div class="col-md-12">
                                                <i class="fa fa-envelope ml-2"></i>
                                                <span  style="color:#000; font-size:90%"><?php echo e($note->detail); ?></span>
                                                <span  style="color:#000; font-size:90%" class="float-left text-muted text-sm"> <?php echo e(\Carbon\Carbon::parse($note->created_at)->diffForHumans(null,true)); ?></span>
        ...
        <ul class="navbar-nav mr-auto">
            <img  style="margin-top: 7px" src="<?php echo e(asset('dist/img/logoautisme.png')); ?>"  >
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <?php if(\Illuminate\Support\Facades\Auth::user()->image): ?>
                            <img class="user-img" style="width:60px;height:60px;"src="<?php echo e(asset('storage/traitants/'.\Illuminate\Support\Facades\Auth::user()->image)); ?>"  alt="Avatar" style="width:70px;height: 50px"/>
                        <?php endif; ?>
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="<?php echo e(route('pagetraitant')); ?>" class="nav-link  <?php if(!$segment ): ?>active <?php endif; ?>">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="<?php echo e(route('pagetraitant.seancetraitements.index')); ?>" class="nav-link  <?php if($segment=='seancetraitements' ): ?>active <?php endif; ?>">
...
<?php /**PATH C:\Users\serour\Downloads\BackRanaMaeak\resources\views/layouts/traitants.blade.php ENDPATH**/ ?>