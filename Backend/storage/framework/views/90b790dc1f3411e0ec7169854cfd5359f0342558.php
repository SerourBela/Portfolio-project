<?php $__env->startSection('title','| تشخيص'); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select   class="form-control" style="width: 470px" id="named" name="enfant_id" >
                                            ...
                                            <?php $__currentLoopData = $enfants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enfant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <option    value="<?php echo e($enfant->dateNaissance); ?>" id="birthday"  hidden></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select   style="width: 468px" id="nametrait" name="trait" >
                                            <option ></option>
                                            <?php $__currentLoopData = $carsspecialistes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trait): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($trait->id_carsspecialiste); ?>" ><?php echo e($trait->nom); ?> <?php echo e($trait->prenom); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" name="date" id="dateD" readonly value="<?php echo e($dateActuelle); ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="container">
                                        <input type="radio" name="r1" id="r1" class="minimal" value="1">
                                ...
                                <div class="form-group">
                                    <label class="container"> ---
                                        <input type="radio" name="r1" id="r1" class="minimal" value="1.5">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="container">
                                        <input type="radio" name="r1" id="r1" class="minimal" value="2" >
                                ...
                                <div class="form-group">
                                    <label class="container"> ---
                                        <input type="radio" name="r1" id="r1" class="minimal" value="2.5">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="container">
                                        <input type="radio" name="r1" id="r1"  class="minimal" value="3" >
                                ...
                                <div class="form-group">
                                    <label class="container"> ---
                                        <input type="radio" name="r1" id="r1" class="minimal" value="3.5">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="container">
                                        <input type="radio" name="r1" id="r1" class="minimal" value="4" >
...
<?php echo $__env->make('layouts.specialistes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\serour\Downloads\BackRanaMaeak\resources\views/pagecarsspecialiste/diagnostics/create.blade.php ENDPATH**/ ?>