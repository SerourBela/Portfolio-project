...
public class Level2Animals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level2_animals);
    ...
    public void showResult(final View v) {
        ...
        builder.setNegativeButton("حفظ", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(v.getContext(), "تم الإرسال", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
        builder.show();
