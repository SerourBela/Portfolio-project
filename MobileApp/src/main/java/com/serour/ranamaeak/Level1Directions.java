...
public class Level1Directions extends AppCompatActivity {
    ...
    String quizData[][] = {
            ...
            {"bear", "bear", "dolphin", "lion", "elephant"},
            {"sinjab", "sinjab", "oiseau", "tortoise", "dolphin"},
            {"rabbit", "rabbit", "oiseau", "cat", "lion"},
            {"oiseau", "oiseau", "elephant", "dog", "lion"},
            {"tortoise", "tortoise", "sinjab", "dolphin", "rabbit"},
            {"elephant", "elephant", "bear", "rabbit", "cat"},
            {"dog", "dog", "cat", "oiseau", "elephant"},
            {"cat", "cat", "bear", "lion", "rabbit"},
            {"dolphin", "dolphin", "dog", "sinjab", "elephant"},
            {"lion", "lion", "oiseau", "cat", "elephant"}
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level1_directions);
